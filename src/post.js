...
/**
 * Builds the firewall job summary from the JSON report. Wrapped in a
 * function (not top-level await) because the CJS bundle target does not
 * support TLA.
 */
export async function run() {
  ...
  core.summary.addRaw('<h2>Socket Firewall Report</h2>')
