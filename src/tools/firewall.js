...
const releases = {
  free: {
    ...
    repo: 'sfw-free',
    checksums: {
      'linux-x64': { asset: 'sfw-free-linux-x86_64', sha256: '4a1e8b65e90fce7d5fd066cf0af6c93d512065fa4222a475c8d959a6bc14b9ff' },
      'linux-arm64': { asset: 'sfw-free-linux-arm64', sha256: 'df2eedb2daf2572eee047adb8bfd81c9069edcb200fc7d3710fca98ec3ca81a1' },
      'darwin-x64': { asset: 'sfw-free-macos-x86_64', sha256: '724ccea19d847b79db8cc8e38f5f18ce2dd32336007f42b11bed7d2e5f4a2566' },
      'darwin-arm64': { asset: 'sfw-free-macos-arm64', sha256: 'bf1616fc44ac49f1cb2067fedfa127a3ae65d6ec6d634efbb3098cfa355e5555' },
      'win32-x64': { asset: 'sfw-free-windows-x86_64.exe', sha256: 'c953e62ad7928d4d8f2302f5737884ea1a757babc26bed6a42b9b6b68a5d54af' }
    }
  },
  enterprise: {
    version: 'v1.6.1',
    ...
    checksums: {
      'linux-x64': { asset: 'sfw-linux-x86_64', sha256: '9115b4ca8021eb173eb9e9c3627deb7f1066f8debd48c5c9d9f3caabb2a26a4b' },
      'linux-arm64': { asset: 'sfw-linux-arm64', sha256: '671270231617142404a1564e52672f79b806f9df3f232fcc7606329c0246da55' },
      'darwin-x64': { asset: 'sfw-macos-x86_64', sha256: '01d64d40effda35c31f8d8ee1fed1388aac0a11aba40d47fba8a36024b77500c' },
      'darwin-arm64': { asset: 'sfw-macos-arm64', sha256: 'acad0b517601bb7408e2e611c9226f47dcccbd83333d7fc5157f1d32ed2b953d' },
      'win32-x64': { asset: 'sfw-windows-x86_64.exe', sha256: '9a50e1ddaf038138c3f85418dc5df0113bbe6fc884f5abe158beaa9aea18d70a' }
    }
  }
}
...
async function createShims (sfwBinaryPath, edition) {
  ...
  const sfwPath = process.platform === 'win32'
    ? msysToWinPath(sfwBinaryPath)
    : sfwBinaryPath
...
export default async function download ({ edition = 'free', ...inputs }) {
  ...
  if (inputs.versionFirewall && inputs.versionFirewall !== 'latest') {
    ...
    core.warning(`Using custom version ${versionToDownload}. Checksum validation will use the hardcoded hash for ${release.version} and may fail if the binary differs.`)
  }
  ...
  core.info(`Socket Firewall ${edition} edition installed: ${versionToDownload}`)
